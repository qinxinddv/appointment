...
export const BlackKey = (props: IBlackKeyProps) => {
  ...
  const { blackKeyList, match, loading, totalItems } = props;
  return (
    <div>
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('key')}>
                  <Translate contentKey="appointmentApp.blackKey.key">Key</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
                ...
                <tr key={`entity-${i}`}>
                  ...
                  <td className="text-right">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${blackKey.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      >
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${blackKey.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
                      >
      ...
      <div className={blackKeyList && blackKeyList.length > 0 ? '' : 'd-none'}>
...
const mapStateToProps = ({ blackKey }: IRootState) => ({
  ...
  totalItems: blackKey.totalItems
});
