...
public class AppointmentConfigResource {
    ...
    public ResponseEntity<List<AppointmentConfigDTO>> getAllAppointmentConfigs(Pageable pageable) {
        log.debug("REST request to get a page of AppointmentConfigs");
        Page<AppointmentConfigDTO> page = appointmentConfigService.findAll(pageable);
