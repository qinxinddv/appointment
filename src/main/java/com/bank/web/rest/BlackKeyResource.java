...
public class BlackKeyResource {
    ...
    public ResponseEntity<List<BlackKeyDTO>> getAllBlackKeys(Pageable pageable) {
        log.debug("REST request to get a page of BlackKeys");
        Page<BlackKeyDTO> page = blackKeyService.findAll(pageable);
